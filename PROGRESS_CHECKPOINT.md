...
* **Homepage Products**: 16 Products across 4 Categories (`vases`: 4, `lighting`: 7, `mirror`: 2, `decor`: 3).
...
* **n8n Workflow**: `fixed_n8n_workflow.json` hardened with Header Auth, 35-char title sanitizer, dynamic `board_id` routing, and transparent error reporting.
