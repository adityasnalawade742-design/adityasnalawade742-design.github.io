...
amazon_url = "https://www.amazon.co.uk/Bedside-Vintage-Reading-Nightstand-Decoration/dp/B0DXKGL1T2"
print("🚀 [Step 1] Extracting Product Details & Multi-Photos for Vintage Bedside Lamp (B0DXKGL1T2)...")
...
final_image_path = add_hook_text_overlay(
    ...
    subtitle=seo_data.get('subtitle_hook', 'VINTAGE AMBIANCE'),
    badge_text=seo_data.get('badge_hook', 'CLASSIC FIND'),
...
summary_path = OUTPUT_DIR / f"vintage_lamp_{prod['id']}_summary.json"
