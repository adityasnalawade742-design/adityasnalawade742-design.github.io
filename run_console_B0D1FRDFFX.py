...
asin = "B0D1FRDFFX"
prod = {
    'title': "Mushroom Lamp Table Lamp for Bedroom,Desk Bedside Small Lamps for Living Room Night Stands,Mushroom Decor Cute Mini Modern Mid Century Lamps,Unique Aesthetic Home Living Room Decor(Orange)",
    'price': "$35.98",
    'rating': "4.5",
    'features': ["PREMIUM QUALITY", "WARM AMBIENT GLOW", "EASY ASSEMBLY"]
}

ref_sheet_path = create_multi_photo_reference_sheet(["https://m.media-amazon.com/images/I/71fyJpZFDYL._AC_SL1500_.jpg"], filename_prefix=f"product_{asin}", max_photos=1)
cozy_prompt = generate_cozy_image_prompt(prod['title'], "Room Lighting", prod['features'], ref_sheet_path, is_white_background=False)
raw_image_path = generate_cozy_image(prompt=cozy_prompt, filename_prefix=f"focus_product_{asin}", init_image_path="https://m.media-amazon.com/images/I/71fyJpZFDYL._AC_SL1500_.jpg", prompt_strength=0.5)
