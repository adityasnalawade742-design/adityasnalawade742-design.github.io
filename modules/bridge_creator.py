...
<body>
    ...
    <div class="container">
        ...
        <footer style="margin-top: 30px; padding-top: 20px; border-top: 1px dashed rgba(255,255,255,0.12); text-align: center; font-size: 12px; color: #64748b;">
            <p style="font-size: 12px; color: var(--accent-gold); font-weight: 700; margin-bottom: 6px;">Company: Cozy Room Finds | App: Cozy Room Decor Publisher Pro</p>
            ...
            <p style="font-size: 11px; line-height: 1.5; color: #64748b;">
                As an Amazon Associate, Cozy Room Finds earns from qualifying purchases. App: Cozy Room Decor Publisher Pro. Developer Contact: <a href="mailto:aditya.s.nalawade147@gmail.com" style="color: var(--accent-gold);">aditya.s.nalawade147@gmail.com</a>.
            </p>
        </footer>
    </div>
