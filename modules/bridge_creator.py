...
<body>
    ...
    <script>
        ...
        (function() {
            const countryMap = {
                // Official Amazon Storefronts & Regional Neighbor Mappings
            ...
            function applyGeoRedirect(cc) {
                ...
                if (!countryMap[targetCC]) {
                    ...
                    if (tz.includes('asia') || tz.includes('kolkata') || tz.includes('calcutta') || tz.includes('singapore')) {
                        targetCC = 'IN';
                    } else if (tz.includes('europe') || tz.includes('london') || tz.includes('berlin') || tz.includes('paris') || tz.includes('stockholm')) {
                        targetCC = 'DE';
                    } else if (tz.includes('australia') || tz.includes('auckland')) {
                        targetCC = 'AU';
                    } else {
                        return;
                    }
