        ...
        (function() {
            ...
            function applyGeoRedirect(cc) {
                ...
                if (regPrice && regPrice === 'Not Available') {
                    ...
                    priceTags.forEach(el => { if (el.classList.contains('tag')) el.innerText = `✨ VERIFIED DEAL • ${regPrice}`; else el.innerText = regPrice; });
                } else {
                    ...
                    priceTags.forEach(el => {
                        if (el.classList.contains('tag')) {
                            ...
                            if (!isDirectListing) { el.style.background = 'rgba(239, 68, 68, 0.25)'; el.style.color = '#fca5a5'; el.style.borderColor = 'rgba(239, 68, 68, 0.4)'; }
                        } else { el.innerText = finalDisplayPrice; }
                    });
                }
