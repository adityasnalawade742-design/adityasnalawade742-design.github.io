...
def process_nextmug_campaign():
    target_url = "https://www.amazon.com/Nextmug-Temperature-Controlled-Self-Heating-Coffee-Mug-Black/dp/B0B6JTX6NB?tag=smartdeal0358-21"
    
    print("=" * 65)
    print(f"🚀 Processing Target Product: Nextmug Temperature-Controlled Mug")
    ...
    if not product:
        ...
        product = {
            "id": "B0B6JTX6NB",
            "title": "Nextmug - Temperature-Controlled Self-Heating Coffee Mug (Matte Black)",
            "category": "Cozy Kitchen & Desk Setup",
            "price": "$99.95",
            "rating": "4.6",
            "reviews_count": 3200,
            "affiliate_url": f"https://www.amazon.com/dp/B0B6JTX6NB?tag={tag}",
            "original_image_url": "https://m.media-amazon.com/images/I/618IaAUvESL._AC_SL1500_.jpg",
            "features": "Built-in rechargeable battery, 3 temperature settings (Warm, Hot, Piping), spill-resistant lid, docking coaster."
        }
    ...
    print("\n🎨 [Step 2] Generating Vision Prompt for Nextmug...")
    ...
    # Step 3: Generate AI Vertical 3:4 Image
    print("\n🖼️ [Step 3] Generating AI Cozy Room Image via FLUX...")
    ...
    summary_path = OUTPUT_DIR / "nextmug_summary.json"
    with open(summary_path, "w", encoding="utf-8") as f:
        json.dump(result, f, indent=2)

    print("\n" + "=" * 65)
    print(f"🎉 Nextmug Campaign Execution Complete!")
