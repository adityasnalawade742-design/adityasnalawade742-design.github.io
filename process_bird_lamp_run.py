...
# Step 4: Replicate FLUX 1.1 Pro 8K Render
print("\n🖼️ [Step 4] Paid Replicate FLUX 1.1 Pro Rendering 8K 3:4 Lifestyle Room Graphic...")
raw_image_path = generate_cozy_image(cozy_prompt, filename_prefix=f"focus_product_{prod['id']}")
print(f" -> FLUX 1.1 Pro Render: {raw_image_path}")
