...
def process_tapestry_campaign():
    target_url = "https://www.amazon.com/Woven-Tapestry-Hanging-Bedroom-Apartment/dp/B08HGVL29K?tag=smartdeal0358-21"
    
    print("=" * 65)
    print(f"🚀 Processing Live Home Decor Product: Boho Woven Arch Wall Tapestry")
    print(f"📌 Niche: {NICHE}")
    print(f"🛍️ Link: {target_url}")
    print("=" * 65)

    # Step 1: Extract Amazon Product Data
    ...
    if not product or not product.get('original_image_url'):
        ...
        product = {
            "id": "B08HGVL29K",
            "title": "Aesthetic Boho Woven Arch Wall Tapestry & Wall Hanging",
            "category": "Home Decor & Wall Art",
            "price": "$18.99",
            "rating": "4.7",
            "reviews_count": 3410,
            "affiliate_url": f"https://www.amazon.com/Woven-Tapestry-Hanging-Bedroom-Apartment/dp/B08HGVL29K?tag={tag}",
            "original_image_url": "https://m.media-amazon.com/images/I/712yfgNo9nL._AC_SL1500_.jpg",
            "features": "Handwoven macrame yarn, geometric arch pattern, neutral cream & beige tones, perfect above bed or living room wall accent."
        }

    # Ensure valid high-res photo URL for Cozy Real Product Frame Renderer
    if not product.get('original_image_url'):
        product['original_image_url'] = "https://m.media-amazon.com/images/I/712yfgNo9nL._AC_SL1500_.jpg"
    ...
    print("\n🎨 [Step 2] Generating Vision Prompt for Boho Tapestry...")
    ...
    final_image_path = add_hook_text_overlay(
        ...
        hook_text="Boho Wall Decor Find 🌾"
    )
    ...
    summary_path = OUTPUT_DIR / "tapestry_summary.json"
    with open(summary_path, "w", encoding="utf-8") as f:
        json.dump(result, f, indent=2)

    print("\n" + "=" * 65)
    print(f"🎉 Boho Tapestry Campaign Execution Complete!")
