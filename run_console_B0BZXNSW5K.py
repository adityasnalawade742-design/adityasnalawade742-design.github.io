...
raw_image_path = generate_cozy_image(prompt=cozy_prompt, filename_prefix=f"focus_product_{asin}", init_image_path="https://m.media-amazon.com/images/I/71zreHoOzVL._AC_SL1500_.jpg", prompt_strength=0.5)
