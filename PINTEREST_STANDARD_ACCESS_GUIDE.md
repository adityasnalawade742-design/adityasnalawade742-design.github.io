...
2. Click on your application: **`Cozy Room Decor Auto Publisher`** (App ID: `1594896`).
...
- **Action**: Display browser tab showing `developers.pinterest.com/apps/1594896`. Point your cursor to **App ID: 1594896** and **App Name: Cozy Room Decor Auto Publisher**.
- **Voiceover / Script**:
  > *"Hello Pinterest API Review Team. This is a live demonstration of our automated content publishing integration for our app Cozy Room Decor Auto Publisher, App ID 1594896."*
