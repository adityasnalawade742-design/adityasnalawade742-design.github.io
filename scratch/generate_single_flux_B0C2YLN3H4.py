...
input_image = repo_dir / "scratch" / "B0C2YLN3H4_candidates" / "option_6.jpg"
if not input_image.exists():
    input_image = "https://m.media-amazon.com/images/I/71GlqYUnnhL._AC_SL1500_.jpg"
else:
...
print(f"📌 Input Reference: Photo 6 ({input_image})")
...
if Path(out_path).exists():
    ...
    print(f"✅ Saved clean Flux Dev image (strength=0.28) to: {clean_target.name}")
