...
if not photos:
    # Fallback high-res listing URLs for B0BPM41R5C
    photos = [
        "https://m.media-amazon.com/images/I/61-+Q3U-gPL._AC_SL1500_.jpg",
        "https://m.media-amazon.com/images/I/71p0W1e-JLL._AC_SL1500_.jpg",
        "https://m.media-amazon.com/images/I/71pU8b3mJ+L._AC_SL1500_.jpg",
        "https://m.media-amazon.com/images/I/61N+V+K5RJL._AC_SL1500_.jpg"
    ]

print(f"Retrieved {len(photos)} candidate photos for B0BPM41R5C:")
